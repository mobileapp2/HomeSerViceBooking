...
public class SplashScreenActivity extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        configSplash.setBackgroundColor(R.color.screen); //any color you want form colors.xml
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.mail); //or any other drawable
        ...
        //Customize Title
        configSplash.setTitleSplash("Perfect Punters"); //change your app name here
        configSplash.setTitleTextColor(R.color.colorPrimary);
        configSplash.setTitleTextSize(25f); //float value
        configSplash.setAnimTitleDuration(3000);
        configSplash.setAnimTitleTechnique(Techniques.FlipInX);
        configSplash.setTitleFont("fonts/calibri.ttf"); //provide string to your font located in assets/fonts/
