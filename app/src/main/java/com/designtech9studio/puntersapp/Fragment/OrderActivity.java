...
public class OrderActivity extends AppCompatActivity implements ProductAdapter.CallBackUs, ProductAdapter.HomeCallBack {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItem.setIcon(Converter.convertLayoutToImage(OrderActivity.this, cart_count, R.drawable.ic_shopping_cart_white_24dp));
        return true;
    }
