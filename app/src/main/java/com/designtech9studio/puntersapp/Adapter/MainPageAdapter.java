...
import com.designtech9studio.puntersapp.Activity.Service_List_Activity;
...
public class MainPageAdapter extends RecyclerView.Adapter<MainPageAdapter.ViewHolder>{
    ...
    public MainPageAdapter(List<CategoryMasterModel> myDataset, Context context){
        values = myDataset;
    ...
    public MainPageAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        MainPageAdapter.ViewHolder vh = new MainPageAdapter.ViewHolder(v);
        return vh;
    }



    public void onBindViewHolder( MainPageAdapter.ViewHolder holder, final int position){
